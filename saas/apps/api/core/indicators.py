...
class TechnicalIndicators:
    ...
    def calculate_macd(
        ...
        """
        macd = MACD(close=close, window_fast=fast, window_slow=slow, window_sign=signal, fillna=fillna)
    ...
    def calculate_bollinger_bands(
        ...
        """
        bb = BollingerBands(close=close, window=period, window_dev=std_dev, fillna=fillna)
    ...
    def calculate_atr(
        ...
        Returns:
            ATR values.
        """
        atr = AverageTrueRange(high=high, low=low, close=close, window=period, fillna=fillna)
    ...
    def count_rsi_crosses(
        ...
        """Count RSI crosses above/below overbought/oversold levels in a rolling window.
        ...
        Returns:
            List of cross counts for each row.
        """
        crosses = []
